    ...
    <ThemedView style={styles.container}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          <View>
            <ThemedText style={styles.greeting}>Olá, Aluno</ThemedText>
            <ThemedText style={styles.subtitle}>Bem-vindo!</ThemedText>
          </View>
        ...
        <View style={[styles.progressSection, { backgroundColor: Colors[theme].card }]}>
          ...
          <View style={styles.progressContent}>
            <View style={styles.beltInfo}>
              <View style={[styles.beltBadge, { backgroundColor: '#FFFFFF', borderColor: '#000000' }]}>
                <ThemedText style={[styles.beltText, { color: '#000000' }]}>Branca</ThemedText>
              </View>
            ...
            <View style={styles.progressStats}>
              <View style={styles.progressItem}>
                ...
                <ThemedText style={styles.progressValue}>59%</ThemedText>
              </View>
              
              <View style={styles.progressBar}>
                <View style={[styles.progressFill, { width: '59%', backgroundColor: Colors[theme].accent }]} />
              </View>
              
              <View style={styles.progressDetails}>
                <View style={styles.detailItem}>
                  <IconSymbol name="figure.martial.arts" size={16} color={Colors[theme].icon} />
                  <ThemedText style={styles.detailText}>24 técnicas aprendidas</ThemedText>
                </View>
                <View style={styles.detailItem}>
                  <IconSymbol name="clock.fill" size={16} color={Colors[theme].icon} />
                  <ThemedText style={styles.detailText}>75 treinos completados</ThemedText>
                </View>
              </View>
            </View>
          </View>
